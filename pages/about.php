...
<head>
  ...
  <title>About | Mama Fua Services</title>
  <link rel="stylesheet" href="../assets/css/style.css">
  <style>
    .about-page { max-width: 1100px; margin: 2rem auto; padding: 2rem; background:#fff; border-radius:24px; box-shadow:0 20px 40px rgba(0,0,0,.08); }
  </style>
</head>
<body>
  <?php include_header(); ?>
